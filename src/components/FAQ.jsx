      ...
      >
        <div className="h-fit flex flex-col gap-6" ref={contentRef}>
          <div className="w-full">
            <Markdown className="w-full prose-lg prose-zinc prose-a:text-light-blue font-regular mt-4">
              {answer.trim()}
            </Markdown>
          </div>
          ...
          {hyperRef && (
            <a
              target="_blank"
              className="bg-cph-blue hover:bg-light-blue transition text-cph-white font-large font-semibold px-11 py-3 rounded-lg self-start"
              href={hyperRef}
            >
              {text}
            </a>
