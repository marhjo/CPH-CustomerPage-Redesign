      ...
      <form className="kontakt-formular" onSubmit={handleSubmit}>
        ...
        <div className="form-flex">
          ...
          <div className="flex-contents">
            <label htmlFor="emailOnly">Kontakt mig venligst kun via email</label>
            <input type="checkbox" id="emailOnly" name="emailOnly" checked={formData.emailOnly} onChange={handleChange} />
          </div>
        </div>
        ...
        {isSent && (
          <div className="modal">
            <div className="modal-content">
              <p>
                Tak for din henvendelse {feedbackData.firstName}. <br /> Vi vender tilbage hurtigst muligt på:
              </p>
